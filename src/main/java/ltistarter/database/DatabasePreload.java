...
//            iss4.setOidcEndpoint("https://lti-ri.imsglobal.org/platforms/2/authorizations/new");
            ...
            LtiKeyEntity key4 = new LtiKeyEntity("key4", "secret4");
            key4 = ltiKeyRepository.save(key4);
            iss4.setKeyId(key4.getKeyId());
            key4.setLti3KeyEntity(iss4);
            ltiKeyRepository.saveAndFlush(key4);
